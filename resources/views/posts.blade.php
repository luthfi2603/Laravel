...
@section('container')
    ...
    @if($posts->count())
        <div class="card mb-4">
            ...
            {{-- <img src="
                @php
                    if($posts[0]->category->name === "Web Programming"){
                        echo"http://localhost:8000/assets/img/web-programing2.jpg";
                    }else if($posts[0]->category->name === "Web Design"){
                            ...
                            {{-- <img src="
                                @php
                                    if($post->category->name === "Web Programming"){
                                        echo"http://localhost:8000/assets/img/web-programing.jpg";
                                    }else if($post->category->name === "Web Design"){
                                        echo"http://localhost:8000/assets/img/web-design.jpg";
                                    }else{
                                        echo"http://localhost:8000/assets/img/personal.jpg";
                                    }
                                @endphp
